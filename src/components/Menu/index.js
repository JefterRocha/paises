...
export default function NavMenu() {
    ...
    return <Navbar className='navbar navbar-expand-lg' expand='lg' bg='primary' variant='dark'>
        <Container className='justify-content-start adjustementNav'>
            ...
            <Navbar.Collapse id='basic-navbar-nav'>
                <Nav className='w-100'>
                    ...
                    <Nav.Link as={Link} to='/graph' href='/graph' className='mx-4'>Gráfico</Nav.Link>
                    <Nav.Link className='mx-4' href='https://querocriarsite.com' target='_blank' rel='noreferrer noopener'>Contato</Nav.Link>
                </Nav>
                <Nav>
                    <Nav.Link href='#deets'>
                        <Button variant='dark'
